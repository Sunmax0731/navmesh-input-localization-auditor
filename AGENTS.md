...
navmesh-input-localization-auditor は Rank 69 の UnityEditor プロダクトです。作業はこのリポジトリ内に限定します。

## Scope

- Repository: D:/AI/UnityEditor/navmesh-input-localization-auditor
- GitHub: https://github.com/Sunmax0731/navmesh-input-localization-auditor
